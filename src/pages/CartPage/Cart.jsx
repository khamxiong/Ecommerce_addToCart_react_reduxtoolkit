...
export const Cart = () => {
 ...
 console.log("deliveryChange", deliveryChange);
  useEffect(() => {
  ...
  return (
    <div className="cart-page">
      ...
      <div className="bg-ghost-white py-5">
        <div className="container">
          <div className="section-titlte bg-ghost-white">
            <h3 className=" text-uppercase text-regal-blue fw-7 ls-1">
              My Cart
            </h3>
          </div>
          <div>
            {cartProducts.length === 0 ? (
              ...
              <div className="cart-content grid">
                    ...
                    {cartProducts.map((cartProduct) => (
                      <div className="cart-item grid" key={cartProduct.id}>
                        ...
                        <div className="cart-item-info">
                          <h6 className="fs-16 fw-5 text-blue">
                            {cartProduct.title}
                          </h6>
                ...
                <div className="cart-right bg-white" style={{padding:".5rem"}}>
